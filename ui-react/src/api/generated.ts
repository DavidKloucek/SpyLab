...
export type BodyFindSimilarImageApiSimilarToImagePostQuality = number | null;
...
export interface BodyFindSimilarImageApiSimilarToImagePost {
  ...
  w: number;
  h: number;
  quality?: BodyFindSimilarImageApiSimilarToImagePostQuality;
}
...
export const getSpyLab = () => {
  ...
  const findSimilarImageApiSimilarToImagePost = (
    ...
    if (
      bodyFindSimilarImageApiSimilarToImagePost.quality !== undefined &&
      bodyFindSimilarImageApiSimilarToImagePost.quality !== null
    ) {
      formData.append(
        `quality`,
        bodyFindSimilarImageApiSimilarToImagePost.quality.toString()
      );
    }
